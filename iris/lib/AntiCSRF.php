...
class AntiCSRF
{
    ...
    /**
     * Insert a CSRF token into a form
     *
     * @param string $lockTo
    ...
    /**
     * Hashing with IP Address removed for GDPR compliance ease,
    ...
    /**
     * Core function that checks for a CSRF attempt.
     *
     * @throws \Exception
     */
    ...
    /**
     * The actual validation of CSRF happens here and returns a boolean
     *
     * @return boolean
     */
    ...
    /**
     * Ensure an IP address is both a valid IP address and does not fall within
